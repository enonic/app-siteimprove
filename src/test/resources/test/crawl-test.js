...
t.mock('/lib/http-client', {
    request: function (params) {
        return {
            "status": 202,
            "message": "",
            "body": "{\"success\":true,\"status_code\":0,\"message\":\"OK. Re-crawl ordered.\"}",
...
exports.testCrawl = function () {
    ...
    var result = siteImproveLib.crawl(123456);

    t.assertTrue(result.body.success);
    t.assertEquals(0, result.body.statusCode);
    t.assertEquals('OK. Re-crawl ordered.', result.body.message);
};
